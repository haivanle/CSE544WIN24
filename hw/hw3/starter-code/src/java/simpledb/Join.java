        ...
        while (leftTuple != null || child1.hasNext()) {
            ...
            while (child2.hasNext()) {
                ...
                if (p.filter(leftTuple, rightTuple)) {
                    // Merge tuples directly here
                    int size1 = leftTuple.getTupleDesc().numFields();
                    int size2 = rightTuple.getTupleDesc().numFields();
                    Tuple mergedTuple = new Tuple(getTupleDesc());
                    for (int i = 0; i < size1; i++) {
                        mergedTuple.setField(i, leftTuple.getField(i));
                    }
                    for (int i = 0; i < size2; i++) {
                        mergedTuple.setField(i + size1, rightTuple.getField(i));
                    }
                    return mergedTuple;
                }
            }
