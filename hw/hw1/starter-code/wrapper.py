...
class DBLPContentHandler(xml.sax.ContentHandler):
  ...
  def startElement(self, name, attrs):
    if name == "dblp":
      DBLPContentHandler.pubFile = open('/Users/suciu/DBLP/pubFile.txt', 'w')
      DBLPContentHandler.fieldFile = open('/Users/suciu/DBLP/fieldFile.txt', 'w')
      DBLPContentHandler.pubList = ["article", "inproceedings", "proceedings", "book", "incollection", "phdthesis", "mastersthesis", "www", "person", "data"]
